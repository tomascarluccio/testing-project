...
public class DashboardPage extends BasePage{
	...
	By systemUpdateTab;
	By loadSystemDataLink;
	By radiusClientsLink;
	...
	public DashboardPage(WebDriver driver, WebDriverWait wait) {
		...
		this.troubleshootingLogLink 	  	= By.xpath("//a[@href='/dblogging/logentry/']");
		...
		this.systemUpdateTab				= By.id("ui-id-8");
		this.loadSystemDataLink				= By.linkText("Load system data");
		this.radiusClientsLink              = By.linkText("Radius clients");
		this.groupsLink			            = By.linkText("Groups");
		this.radiusServerPort               = By.xpath("//*[@id=\"module_9\"]/div/ul[1]/li[4]/ul/li");
	...
	public WebElement getTroubleshootingLogLink() {
		return this.driver.findElements(this.troubleshootingLogLink).get(1);
	}
	...
	public WebElement getSystemUpdateTab() {
		return this.driver.findElement(this.systemUpdateTab);
	}
	
	public WebElement getLoadSystemDataLink() {
		return this.driver.findElement(this.loadSystemDataLink);
	}
	
	public WebElement getRadiusClientsLink() {
		return this.driver.findElement(this.radiusClientsLink);
	}
	
	public WebElement getGroupsLink() {
		return this.driver.findElement(this.groupsLink);
	}
	
	public WebElement getRadiusPort() {
		return this.driver.findElement(this.radiusServerPort);
  	}
